...
public class ServiceUserActivity extends MenuInheritActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button phoneCall = (Button) findViewById(R.id.makeCall2);
		phoneCall.setOnClickListener(new ButtonClick());
		Button sendSms1 = (Button) findViewById(R.id.sendSms2);
		...
		cancel.setOnClickListener(new ButtonClick().dialogOnClick(dialog, cancel));
